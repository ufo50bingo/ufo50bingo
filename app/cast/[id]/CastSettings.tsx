...
export default function CastSettings({ shownDifficulties, setShownDifficulties }: Props) {
        ...
        <>
            ...
            <Drawer.Root
                ...
                <Drawer.Content style={{ boxShadow: '-0.2em 0 0.4em black' }}>
                    ...
                    <Drawer.Body>
                        <Stack>
                            <ColorSelector label="Left player color" color={leftColor} setColor={setLeftColor} />
                            <ColorSelector label="Right player color" color={rightColor} setColor={setRightColor} />
