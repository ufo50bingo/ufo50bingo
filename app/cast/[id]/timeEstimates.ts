...
export const GIFT_DESCRIPTIONS: Descriptions = Object.fromEntries(GIFT_DESCRIPTION_ENTRIES);
...
export type TerminalEntry = Game | { type: 'include' | 'exclude', code: string, game: Game };
