export const BLITZ = [
  [
    ...
    {
      name: "ATTACTICS: Reach Corporal in ranked mode (Rank 30)",
      types: ["attactics"],
    },
    ...
    {
      name: "AVIANOS: Create 20 units with Quetzal's Muster",
      types: ["avianos"],
    },
    ...
    {
      name: "PARTY HOUSE: Max out popularity and cash at the same time",
      types: ["partyhouse"],
    },
    {
      name: "HYPER CONTENDER: Win Round 4 of the Tournament",
  ...
  [
    {
      name: "THE BIG BELL RACE: Win 3 different courses without dying",
    ...
    {
      name: "STAR WASPIR: Clear wave 1 with the Yellow Ship",
      types: ["starwaspir"],
    },
    {
    ...
    {
      name: "MAGIC GARDEN: Obtain a score multiplier of 4x",
      types: ["magicgarden"],
    },
    {
      name: "BARBUTA: Die to the Red Phantom (Small Map Square)",
      types: ["barbuta"],
    },
  ...
  [
    ...
    {
      name: "NINPEK: Kill 7 enemies while dead in one playthrough",
      types: ["ninpek"],
    },
    { name: "VELGRESS: Buy 5 items from shops", types: ["velgress"] },
    { name: "CAMPANELLA 2: Clear Burrows II", types: ["campanella2"] },
    {
      name: "BUG HUNTER: Have 3 energy end up on the same tile",
      types: ["bughunter"],
    },
  ...
  [
    {
      name: "FIST HELL: Get money by collecting food at full health",
      types: ["fisthell"],
    },
    {
    ...
    {
      name: "WARPTANK: Collect a coffee (must beat level with it)",
      types: ["warptank"],
    },
    ...
    {
      name: "CARAMEL CARAMEL: Snap 8 bonus background elements",
  ...
  [
    ...
    {
      name: "CAMOUFLAGE: Get eaten by Frog, Gator, & Bird",
      types: ["camouflage"],
    },
  ...
  [
    ...
    {
      name: "ROCK ON! ISLAND: Use CLUB-PASS; beat Crossroads",
      types: ["rockonisland"],
    },
    { name: "MORTOL: Clear 2-B using OPEN-TOMB", types: ["mortol"] },
    { name: "ELFAZAR’S HAT: Clear the first stage", types: ["elfazarshat"] },
    {
      name: "BUSHIDO BALL: Beat round 3 with default settings",
      types: ["bushidoball"],
    },
    {
      name: "QUIBBLE RACE: Train a Quibble to have 70+ speed",
      types: ["quibblerace"],
    },
  ...
  [
    ...
    {
      name: "CARAMEL CARAMEL: Beat the Cookie or the Egg",
      types: ["caramelcaramel"],
    },
    {
      name: "STAR WASPIR: Clear wave 1 with the Red Ship",
      types: ["starwaspir"],
    },
    {
      name: "LORDS OF DISKONIA: Win the first story mission",
      types: ["lordsofdiskonia"],
    },
    {
      name: "MAGIC GARDEN: Save 10+ Oppies at once twice",
      types: ["magicgarden"],
    },
    {
  ...
  [
    {
      name: "GRIMSTONE: Talk to the Angel Zad in Mission Francesco (south)",
      types: ["grimstone"],
    },
    {
      name: "MINI & MAX: Stand on the hanging lamp in the upper right",
      types: ["miniandmax"],
    },
    {
      name: "ATTACTICS: Have at least 10 Grunts in formation",
      types: ["attactics"],
    },
    {
    ...
    {
      name: "WALDORF’S JOURNEY: Reach at least 50%",
      types: ["waldorfsjourney"],
    },
    {
      name: "Buy an item from a shop in 5 different games",
      types: ["general"],
    },
  ],
  ...
  [
    ...
    {
      name: "FIST HELL: Survive 6 waves in the gym (left of start)",
      types: ["fisthell"],
    },
    {
    ...
    {
      name: "PAINT CHASE: Get 30+ points from a single level",
      types: ["paintchase"],
    },
  ...
  [
    ...
    {
      name: "VAINGER: Visit Latom Sector (via the top left corner)",
      types: ["vainger"],
    },
    {
      name: "PARTY HOUSE: Get busted by the fire department",
      types: ["partyhouse"],
    },
    {
    ...
    {
      name: "COMBATANTS: Have an army of 5+ NPC Soldier Ants",
      types: ["combatants"],
    },
  ...
  [
    ...
    {
      name: "RAIL HEIST: Use LAZY-COPS; Beat Root Around & Sitting Ducks",
      types: ["railheist"],
    },
    {
      name: "DEVILITION: Beat the first round in under a minute",
      types: ["devilition"],
    },
    ...
    {
      name: "CAMPANELLA 2: Clear Moire Woods I or Rink I",
      types: ["campanella2"],
    },
    { name: "CAMPANELLA: Defeat the Stage A Boss", types: ["campanella"] },
    {
      name: "WALDORF’S JOURNEY: Use four unique items in one run",
      types: ["waldorfsjourney"],
    },
  ...
  [
    {
      name: "PAINT CHASE: Get an extra life by getting 120+ points",
      types: ["paintchase"],
    },
    ...
    {
      name: "CYBER OWLS: Clear any 2 Rescue Missions using GETM-EOUT",
      types: ["cyberowls"],
    },
  ...
  [
    {
      name: "MOONCAT: Cross the wizard's bridge (main path)",
      types: ["mooncat"],
    },
    {
      name: "PINGOLF: Slam dunk the ball into the hole on 6 courses",
      types: ["pingolf"],
    },
    ...
    {
      name: "VAINGER: Visit Verde Sector (via either bottom corner",
      types: ["vainger"],
    },
    {
      name: "RAKSHASA: Revive yourself 4 times in one run",
      types: ["rakshasa"],
    },
    {
  ...
  [
    ...
    {
      name: "HOT FOOT: Make the coach stop you from stalling by hoarding",
      types: ["hotfoot"],
    },
    { name: "VELGRESS: Bounce on the giant squid", types: ["velgress"] },
    { name: "CAMPANELLA 3: Beat Galbrain (Stage A)", types: ["campanella3"] },
    {
      name: "ATTACTICS: Have 5 promoted units alive at once",
      types: ["attactics"],
    },
  ...
  [
    {
      name: "GRIMSTONE: Reach Level 3 with any character",
      types: ["grimstone"],
    },
    { name: "MAGIC GARDEN: Save 100 Oppies in a run", types: ["magicgarden"] },
    {
      name: "OVERBOLD: Buy 7 different upgrades in one run",
      types: ["overbold"],
    },
    {
    ...
    {
      name: "PARTY HOUSE: Have 6 trouble in your party at once",
      types: ["partyhouse"],
    },
    { name: "LORDS OF DISKONIA: Have 25+ gold", types: ["lordsofdiskonia"] },
    {
      name: "ROCK ON! ISLAND: Use CLUB-PASS; beat Oasis",
      types: ["rockonisland"],
    },
  ...
  [
    ...
    {
      name: "WALDORF’S JOURNEY: Collect 3 puffins in one run",
      types: ["waldorfsjourney"],
    },
    ...
    {
      name: "ELFAZAR’S HAT: Beat the tree stump miniboss",
      types: ["elfazarshat"],
    },
    {
      name: "BUG HUNTER: Kill 5 bugs using non-attack modules",
      types: ["bughunter"],
    },
    { name: "BARBUTA: Kill 10 enemies", types: ["barbuta"] },
    {
      name: "HYPER CONTENDER: Win a fight using code PAST-RULE",
      types: ["hypercontender"],
    },
    {
      name: "Enter a top 5 score on 3 arcade leaderboards",
      types: ["general"],
    },
  ],
  ...
  [
    ...
    {
      name: "BLOCK KOALA: Make and beat a custom level",
      types: ["blockkoala"],
    },
    {
      name: "AVIANOS: Kill 10 units with Tri-lock's lightning",
      types: ["avianos"],
    },
    {
      name: "Enter a top 3 score on an arcade leaderboard",
      types: ["general"],
    },
  ],
  ...
  [
    ...
    {
      name: "OVERBOLD: Complete a wave with $500+ stakes",
      types: ["overbold"],
    },
    {
      name: "NIGHT MANOR: Successfully hide from the killer",
      types: ["nightmanor"],
    },
    {
      name: "GRIMSTONE: Put money in the bank in Santonio (north)",
      types: ["grimstone"],
    },
    { name: "GOLFARIA: Destroy 2 parbots", types: ["golfaria"] },
    {
      name: "BUSHIDO BALL: Beat round 2 on Hyper Speed",
      types: ["bushidoball"],
    },
    { name: "VELGRESS: Use 5 jump pads", types: ["velgress"] },
    {
      name: "PORGY: Retrieve the Missiles from the lower right caves",
      types: ["porgy"],
    },
  ...
  [
    ...
    {
      name: "LORDS OF DISKONIA: Make an enemy disk drown",
      types: ["lordsofdiskonia"],
    },
    { name: "CARAMEL CARAMEL: Score 20,000 points", types: ["caramelcaramel"] },
    { name: "FIST HELL: Have $30 at once", types: ["fisthell"] },
    {
      name: "MORTOL: Use LEAF-HEAD, turn 5 enemies into vines",
      types: ["mortol"],
    },
    {
      name: "VALBRACE: Defeat the crone (steal from her)",
      types: ["valbrace"],
    },
    {
      name: "Beat 1 level/scenario in 3 different epic play games",
      types: ["general"],
    },
  ],
  ...
  [
    ...
    {
      name: "ROCK ON! ISLAND: Have 15 chickens at once in a main level",
      types: ["rockonisland"],
    },
  ...
  [
    {
      name: "ONION DELIVERY: Heal 8 HP without dying",
      types: ["oniondelivery"],
    },
    ...
    {
      name: "PILOT QUEST: Have 50 Moon Drops in the Wild Zone",
      types: ["pilotquest"],
    },
    { name: "CYBER OWLS: Clear Moscow", types: ["cyberowls"] },
    {
      name: "Fall into a (non-water) pit in 3 different games",
      types: ["general"],
    },
  ],
  ...
  [
    ...
    {
      name: "CAMPANELLA 2: Upgrade your max health or max fuel",
      types: ["campanella2"],
    },
    {
  ...
  [
    ...
    {
      name: "CARAMEL CARAMEL: Score 5,000 points in the prologue",
      types: ["caramelcaramel"],
    },
    { name: "MAGIC GARDEN: Kill 4 mushrooms", types: ["magicgarden"] },
    { name: "BUG HUNTER: Complete your first job", types: ["bughunter"] },
    {
      name: "BLOCK KOALA: Make 3 different blocks into metal 5 blocks",
      types: ["blockkoala"],
    },
    {
      name: "ATTACTICS: Score 500+ points in Survival Mode",
      types: ["attactics"],
    },
  ...
  [
    ...
    {
      name: "PARTY HOUSE: Get any guest to 9 popularity",
      types: ["partyhouse"],
    },
    {
    ...
    {
      name: "VAINGER: Recharge at 5 different checkpoints",
      types: ["vainger"],
    },
  ...
  [
    ...
    {
      name: "STAR WASPIR: Clear Wave 1 with the Gray Ship",
      types: ["starwaspir"],
    },
    ...
    {
      name: "AVIANOS: Enter combat with extra reserves (>40 units)",
      types: ["avianos"],
    },
