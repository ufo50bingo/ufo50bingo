export const SEASON_1_UFO = {
  goals: {
    easy: {
      barbuta: ["BARBUTA: Collect the reward from a green skull"],
      bughunter: [
      ...
      ninpek: ["NINPEK: Collect 3 crowns"],
      paintchase: [
        "PAINT CHASE: Beat 6 levels",
        "PAINT CHASE: EVEN-COAT allowed; beat courses 16, 17, and 20 while destroying all spike mines",
      ],
      magicgarden: ["MAGIC GARDEN: Use OVER-GROW; Save 30+ oppies in a run"],
      mortol: ["MORTOL: Earn six 1-ups by killing enemies"],
      velgress: [
      ...
      golfaria: ["GOLFARIA: Collect 3 clubs", "GOLFARIA: Hit 3 eagles"],
      thebigbellrace: [
        "THE BIG BELL RACE: KO an opponent with 3 unique power-ups",
      ],
      warptank: ["WARPTANK: Complete the three levels in the initial hub room"],
      waldorfsjourney: [
      ...
      divers: ["DIVERS: Reach level 3"],
      railheist: [
        "RAIL HEIST: Kill 5 chickens",
        "RAIL HEIST: LAZY-COPS allowed; beat Root Around while destroying every barrel",
      ],
      vainger: ["VAINGER: Defeat a boss"],
      rockonisland: ["ROCK ON! ISLAND: Have 20 chickens in a main level"],
      pingolf: [
      ...
      overbold: ["OVERBOLD: Purchase 3 price hiked items in one run"],
      campanella2: [
      ...
      pilotquest: ["PILOT QUEST: Plant 4 seeds at the crash site"],
      miniandmax: [
        "MINI & MAX: Rid the books of Silverfish",
        "MINI & MAX: Slay the Water Bear in the west pot",
      ],
      combatants: ["COMBATANTS: Beat ‘First Blood’ without shooting"],
      quibblerace: [
      ...
      cyberowls: ["CYBER OWLS: Earn a 1-Up (extra owl)"],
    },
    hard: {
      barbuta: [
      ...
      bughunter: ["BUG HUNTER: Complete a job with your energy maxed out"],
      ninpek: ["NINPEK: Gold disk"],
      paintchase: ["PAINT CHASE: Reach a score of 240+"],
      magicgarden: [
      ...
      kickclub: ["KICK CLUB: Have 5 extra lives at once"],
      avianos: [
        "AVIANOS: Win the campaign Hatchling game without using any Miracles",
      ],
      mooncat: ["MOONCAT: Visit 12 different rooms"],
      camouflage: ["CAMOUFLAGE: Escape with 3/3 collectibles on 5 levels"],
      campanella: [
        "CAMPANELLA: Finish Stage C only earning points from bosses and bonus stages",
        "CAMPANELLA: Have 20 lives",
      ],
      warptank: ["WARPTANK: SLIM-TANK allowed; clear Riot and Soft Sectors"],
      waldorfsjourney: [
      ...
      divers: ["DIVERS: Obtain any Lance weapon", "DIVERS: Purchase Godblood"],
      railheist: [
        "RAIL HEIST: Collect 9 total stars",
        "RAIL HEIST: LAZY-COPS allowed; beat Vengeance! and The Final Score",
      ],
      vainger: ["VAINGER: Beat 3 bosses", "VAINGER: Collect 1 keycode"],
      rockonisland: [
      ...
      fisthell: ["FIST HELL: Survive 9 waves in the gym"],
      overbold: [
      ...
      grimstone: ["GRIMSTONE: Reach Level 4 with any character"],
      nightmanor: [
        "NIGHT MANOR: Successfully complete the hiding minigame in five different rooms",
      ],
      elfazarshat: ["ELFAZAR’S HAT: Clear Stage 3 (Frostin Town)"],
      pilotquest: [
      ...
      combatants: ["COMBATANTS: Beat 4 levels", "COMBATANTS: Slay a spider"],
      seasidedrive: ["SEASIDE DRIVE: Reach 200,000+ points"],
      campanella3: ["CAMPANELLA 3: Beat Joe Pulp (Stage 3 Boss)"],
      cyberowls: [
    ...
    medium: {
      ...
      ninpek: ["NINPEK: Eat 5 sandwiches", "NINPEK: Score 16,000+ points"],
      paintchase: [
      ...
      mooncat: ["MOONCAT: Defeat 6 unique enemy types", "MOONCAT: Gold disk"],
      bushidoball: [
      ...
      blockkoala: ["BLOCK KOALA: Beat 5 story levels"],
      camouflage: ["CAMOUFLAGE: Gold disk", "CAMOUFLAGE: Save 5 babies"],
      campanella: [
      ...
      hotfoot: ["HOT FOOT: Win 2 games in a row without jumping"],
      divers: [
      ...
      fisthell: ["FIST HELL: Destroy 2 UFOs", "FIST HELL: Have $50 at once"],
      overbold: [
      ...
      grimstone: ["GRIMSTONE: Collect the money from the burned house"],
      lordsofdiskonia: [
      ...
      combatants: ["COMBATANTS: Beat ‘Surprise!’"],
      quibblerace: ["QUIBBLE RACE: WILD-BETS allowed; Have $25,000"],
      seasidedrive: [
      ...
      campanella3: ["CAMPANELLA 3: Clear 4 waves 100%"],
      cyberowls: [
    ...
    veryhard: {
      ...
      magicgarden: ["MAGIC GARDEN: Reach a score of 50,000+"],
      mortol: ["MORTOL: Use BENS-MODE; beat 2-C with 50+ lives"],
      ...
      blockkoala: ["BLOCK KOALA: WORM-1234 allowed; Clear 9 story levels"],
      camouflage: ["CAMOUFLAGE: Reach 70% completion or more"],
      campanella: ["CAMPANELLA: Gold disk"],
      golfaria: ["GOLFARIA: Achieve 20% Completion"],
      warptank: ["WARPTANK: Beat any 9 levels and talk to 3 NPCs"],
      waldorfsjourney: ["WALDORF’S JOURNEY: Enter the palace with 6 Puffins"],
      porgy: ["PORGY: Achieve 20% Completion"],
      oniondelivery: ["ONION DELIVERY: Gold disk"],
      caramelcaramel: ["CARAMEL CARAMEL: Gold disk"],
      partyhouse: ["PARTY HOUSE: Beat any 3 of the 5 default scenarios"],
      hotfoot: ["HOT FOOT: Gold disk"],
      railheist: ["RAIL HEIST: Collect 9 Devil Stars"],
      vainger: ["VAINGER: Get the Force Mod from Verde Sector"],
      rockonisland: ["ROCK ON! ISLAND: Clear 3 main levels"],
      fisthell: ["FIST HELL: Beat the 4th scare (Boardwalk Bash)"],
      overbold: ["OVERBOLD: Cherry disk"],
      campanella2: [
        "CAMPANELLA 2: Obtain 6 power-up items in one run (square icons on left of screen)",
      ],
      valbrace: ["VALBRACE: Defeat the Phantom Knight on Floor 2"],
