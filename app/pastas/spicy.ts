export const SPICY = [
  ...
  [
    ...
    {
      name: "ELFAZAR’S HAT: Defeat every enemy and boss in stages 1 & 3 in a run",
      types: ["elfazarshat", "medium"],
    },
    {
  ...
  [
    {
      name: "PINGOLF: Cherry with a score of -12 or better",
      types: ["pingolf", "hard"],
    },
    {
      name: "PINGOLF: Cherry with 3+ holes-in-one in the run",
      types: ["pingolf", "hard"],
    },
    {
    ...
    {
      name: "RAIL HEIST: LAZY-COPS allowed; Beat any 8 levels (1, 2, 3 & 18 excluded) without allowing the lawmen to have more than two turns",
      types: ["railheist", "hard"],
    },
    {
  ...
  [
    ...
    {
      name: "VAINGER: Collect 3+ modules, then defeat Y-Vainger (exploit not allowed)",
      types: ["vainger", "hard"],
    },
    {
      name: "VAINGER: Collect 3+ modules, then defeat the keycode boss in Theta Sector",
      types: ["vainger", "hard"],
    },
  ...
  [
    ...
    {
      name: "BARBUTA: Pay the hammer man to enter the castle and defeat the boss",
      types: ["barbuta", "hard"],
    },
    {
      name: "BARBUTA: Enter five unique doors (exits do not count as new doors)",
      types: ["barbuta", "hard"],
    },
    {
  ...
  [
    ...
    {
      name: "VAINGER: Obtain and equip all four modules and two keycodestro",
      types: ["vainger", "veryhard"],
    },
    {
