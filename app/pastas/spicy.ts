...
{"name": "MORTOL: Clear the first two levels without using the Ritual of Arrow or collecting any +3 or +5 life pickups", "types": ["mortol", "easy"]},
	...
	{"name": "CYBER OWLS: Beat Moscow; you must enter the Hackoon fight with 0 bullets", "types": ["cyberowls", "hard"]},
...
{"name": "BARBUTA: Cherry disk while holding the Rod", "types": ["barbuta", "medium"]},
  ...
  [
	{"name": "PINGOLF: Cherry with a score of -12 or better", "types": ["pingolf", "hard"]},
...
{"name": "NIGHT MANOR: Successfully complete the hiding minigame in five different rooms in a row without failing", "types": ["nightmanor", "hard"]},
	...
	{"name": "RAIL HEIST: LAZY-COPS allowed; Beat any 8 levels (1, 2, 3 & 18 excluded) without allowing the lawmen to have more than two turns", "types": ["railheist", "hard"]},
...
{"name": "CARAMEL CARAMEL: Score 50,000+ points by the end of Orb Shower A", "types": ["caramelcaramel", "hard"]},
...
{"name": "ONION DELIVERY: Deliver 10 onions and complete the day on 4 separate days in a run", "types": ["oniondelivery", "hard"]}
  ...
  [
	...
	{"name": "OVERBOLD: Gold disk; You may only purchase upgrades in one specific row", "types": ["overbold", "medium"]},
...
{"name": "CARAMEL CARAMEL: Cherry disk with max of 1 death", "types": ["caramelcaramel", "veryhard"]},
	...
	{"name": "VAINGER: Obtain and equip all four modules and two keycodestro", "types": ["vainger", "veryhard"]},
