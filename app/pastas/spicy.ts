...
{"name": "ELFAZAR’S HAT: Defeat every enemy and boss in stages 1 & 3 in a run", "types": ["elfazarshat", "medium"]},
...
[
	...
	{"name": "BUG HUNTER: Complete a job with at least 15 holes on the board", "types": ["bughunter", "medium"]},
...
{"name": "BARBUTA: Cherry disk while holding the Rod", "types": ["barbuta", "medium"]},
	...
	{"name": "OVERBOLD: Gold disk; you may ONLY purchase SALE or HIKE items", "types": ["overbold", "medium"]},
  ...
  [
	...
	{"name": "PINGOLF: Cherry with 3+ holes-in-one in the run", "types": ["pingolf", "hard"]},
	{"name": "KICK CLUB: Have 7 extra lives at once", "types": ["kickclub", "hard"]},
	{"name": "KICK CLUB: Beat Track World; Must finish each level in the run (except bosses) with 15+ seconds left on the timer", "types": ["kickclub", "hard"]},
...
[
	...
	{"name": "VAINGER: Collect 3+ modules, then defeat Y-Vainger (exploit not allowed)", "types": ["vainger", "hard"]},
{"name": "VAINGER: Collect 3+ modules, then defeat the keycode boss in Theta Sector", "types": ["vainger", "hard"]},
...
{"name": "PORGY: Defeat a boss in the second depth level (Bakunawa or Neptune)", "types": ["porgy", "hard"]},
	...
	{"name": "BARBUTA: Pay the hammer man to enter the castle and defeat the boss", "types": ["barbuta", "hard"]},
	{"name": "BARBUTA: Enter five unique doors (exits do not count as new doors)", "types": ["barbuta", "hard"]},
...
{"name": "ONION DELIVERY: Deliver 10 onions and complete the day on 4 separate days in a run", "types": ["oniondelivery", "hard"]}
  ...
  [
	...
	{"name": "MINI & MAX: Have 350 shinies at once", "types": ["miniandmax", "hard"]},
...
{"name": "ROCK ON! ISLAND: CLUB-PASS allowed; Beat the Four Emperors with 15 HP or more remaining", "types": ["rockonisland", "veryhard"]}
  ...
  [
	...
	{"name": "FIST HELL: Beat the fourth scare as Cat or Amy; Limit of 2 upgrade purchases", "types": ["fisthell", "veryhard"]},
