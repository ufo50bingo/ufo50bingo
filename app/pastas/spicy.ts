...
{"name": "GRIMSTONE: With a party of 4, level up all members to level 3", "types": ["grimstone", "easy"]},
	{"name": "RAKSHASA: Clear Stage 2 defeating enemies ONLY with the spread weapon during the run", "types": ["rakshasa", "easy"]},
	{"name": "RAKSHASA: Clear Stage 2 defeating enemies ONLY with the purple homing weapon during the run", "types": ["rakshasa", "easy"]},
...
[
{"name": "BARBUTA: Obtain the blood sword, die an additional four times in that room (5 deaths total), then gold disk", "types": ["barbuta", "easy"]},
...
[
	...
	{"name": "MAGIC GARDEN: Cherry disk in under 6:00 in-game time", "types": ["magicgarden", "medium"]},
	{"name": "MAGIC GARDEN: Gold disk; Must “dizzy” at least 3 blue oppies each season by jumping over them", "types": ["magicgarden", "medium"]},
...
[
	{"name": "HYPER CONTENDER: Win tournament mode with two different characters; no rematches allowed (Default ring settings)", "types": ["hypercontender", "medium"]},
...
{"name": "MOONCAT: Obtain the Yellow and Green eggs", "types": ["mooncat", "hard"]},
	{"name": "WARPTANK: SLIM-TANK allowed; clear Dyad, Shock, and Port Sectors (no checkpoints)", "types": ["warptank", "hard"]},
{"name": "WARPTANK: SLIM-TANK allowed; clear Axon, Deep, and Sacrum Sectors (no checkpoints)", "types": ["warptank", "hard"]},
