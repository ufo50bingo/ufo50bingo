export const SPICY = [
  [
    ...
    {
      name: "CAMPANELLA 2: Collect a total of 6 max HP & max fuel upgrades combined in a run",
  ...
  [
    {
      name: "BARBUTA: Obtain the blood sword, leave the room with 0 eggs, then gold disk",
      types: ["barbuta", "easy"],
    },
    ...
    {
      name: "OVERBOLD: Gold Disk without purchasing any SALE items",
      types: ["overbold", "easy"],
    },
    {
  ...
  [
    ...
    {
      name: "CYBER OWLS: Have 5 extra lives at once",
  ...
  [
    ...
    {
      name: "CAMPANELLA: Defeat every enemy on every level (no warps) in worlds A & B without collecting any other points",
      types: ["campanella", "medium"],
    },
    {
  ...
  [
    ...
    {
      name: "MAGIC GARDEN: Cherry disk in under 5:05 in-game time",
      types: ["magicgarden", "medium"],
    },
    {
      name: "MAGIC GARDEN: Gold disk; Ignore the first 5 drop-offs and never kill the mushrooms that spawn",
      types: ["magicgarden", "medium"],
    },
    {
    ...
    {
      name: "GRIMSTONE: Win four encounters in the western mine in one visit",
    ...
    {
      name: "ATTACTICS: Earn the gift; beat each of those levels without losing any flags",
      types: ["attactics", "medium"],
    },
  ],
  [
    ...
    {
      name: "PINGOLF: Score -2 or better on six holes",
      types: ["pingolf", "medium"],
    },
    {
      name: "PINGOLF: Score PAR better on eight holes in a row without dunking",
      types: ["pingolf", "medium"],
    },
    {
  ...
  [
    ...
    {
      name: "HYPER CONTENDER: Win tournament mode; Change ring settings to the following values in order: 6, 1, 1, 5 ,5",
      types: ["hypercontender", "medium"],
    },
    {
  ...
  [
    ...
    {
      name: "GOLFARIA: Rescue 3 NPCs and hit 2 Parbots",
  ...
  [
    {
      name: "PINGOLF: Cherry with a score of -9 or better",
      types: ["pingolf", "hard"],
    },
    {
      name: "PINGOLF: Cherry with 3+ hole-in-one in the run",
      types: ["pingolf", "hard"],
    },
    {
  ...
  [
    ...
    {
      name: "WARPTANK: Change your tank to each available color in the hub world (there are 5 color platforms)",
      types: ["warptank", "hard"],
    },
    {
    ...
    {
      name: "DEVILITION: Use FULL-RAND; Beat 6 levels",
  ...
  [
    ...
    {
      name: "RAKSHASA: Gold disk with the default weapon only",
      types: ["rakshasa", "hard"],
    },
    {
      name: "MAGIC GARDEN: Gold Disk with 9,900 points or less",
    ...
    { name: "ATTACTICS: Cherry disk", types: ["attactics", "hard"] },
    {
      name: "DIVERS: Reach level 3 and collect an emblem",
      types: ["divers", "hard"],
    },
    ...
    {
      name: "ONION DELIVERY: Deliver 10 onions and complete the day on 4 separate days",
  ...
  [
    ...
    {
      name: "BARBUTA: Explore 48 different rooms",
      types: ["barbuta", "veryhard"],
    },
    ...
    {
      name: "MAGIC GARDEN: Win with a score of 100,000+",
  ...
  [
    ...
    { name: "CAMPANELLA: Cherry disk", types: ["campanella", "veryhard"] },
    {
      name: "WARPTANK: Enter the cafe with at least 9 coffees",
    ...
    {
      name: "CARAMEL CARAMEL: Cherry disk",
      types: ["caramelcaramel", "veryhard"],
    },
    {
    ...
    {
      name: "VAINGER: Obtain and equip all four modules",
      types: ["vainger", "veryhard"],
    },
    {
      name: "PARTY HOUSE: Beat 3 random scenarios in a row",
  ...
  [
    ...
    {
      name: "MORTOL: Have 80 lives at the end of a level",
    ...
    {
      name: "HOT FOOT: Cherry disk without Edgar or July",
  ...
  [
    {
      name: "RAKSHASA: Cherry disk with at least 55,000 points",
      types: ["rakshasa", "veryhard"],
    },
    {
      name: "RAKSHASA: Gold disk without upgrading the weapon",
      types: ["rakshasa", "veryhard"],
    },
    {
    ...
    {
      name: "ONION DELIVERY: Cherry Disk",
  ...
  [
    ...
    {
      name: "Enter a top 2 score on 3 arcade leaderboards",
      types: ["general", "general"],
    },
  ],
  [
    ...
    {
      name: "Cherry Disk Avianos or Hyper Contender",
      types: ["general", "general"],
    },
    {
    ...
    {
      name: "Obtain the gift in Lords of Diskonia or beat 30 levels in Block Koala",
      types: ["general", "general"],
    },
  ...
  [
    ...
    {
      name: "ADVENTUREVANIA: Defeat 8 total bosses across Vainger, Porgy, Mini & Max, and Warptank with at least one in each",
      types: ["general", "general"],
    },
  ],
] as const;
