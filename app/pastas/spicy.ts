export const SPICY = [
  ...
  [
    ...
    {
      name: "CYBER OWLS: Beat Congo & Moscow without killing (or sleep-darting) any non-boss enemies",
    ...
    {
      name: "MINI & MAX: Have 360 shinies at once",
      types: ["miniandmax", "hard"],
    },
    {
  ...
  [
    ...
    {
      name: "BLOCK KOALA: WORM-1234 allowed; clear any 12 even-numbered story levels (levels 1-10 excluded)",
      types: ["blockkoala", "veryhard"],
    },
  ...
  [
    ...
    {
      name: "WALDORF’S JOURNEY: Cherry disk; No puffins collected & at least 5 weather vanes must be activated during the run",
