export const SPICY = [
  [
    ...
    {
      name: "CAMPANELLA 2: Collect 4 max HP upgrades in a run",
  ...
  [
    ...
    {
      name: "THE BIG BELL RACE: Cherry disk",
  ...
  [
    ...
    {
      name: "MAGIC GARDEN: Gold disk; Must “dizzy” at least 3 blue oppies each season by jumping over them",
      types: ["magicgarden", "medium"],
    },
    {
  ...
  [
    ...
    {
      name: "ATTACTICS: Reach Rank 100 in Ranked Mode",
      types: ["attactics", "hard"],
    },
    {
