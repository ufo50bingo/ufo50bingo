export const SPICY = [
  [
	...
	{"name": "PARTY HOUSE: Have 8 trouble on screen at once without using any fetch or peek abilities", "types": ["partyhouse", "easy"]},
	{"name": "PARTY HOUSE: Get 4 climbers to 9 popularity & win the scenario", "types": ["partyhouse", "easy"]},
	{"name": "VAINGER: Defeat 3 bosses with all obtained modules placed in BODY", "types": ["vainger", "easy"]},
...
{"name": "ROCK ON! ISLAND: CLUB-PASS allowed; Perfect Underbrush with 4 or fewer cavemen, and no chickens", "types": ["rockonisland", "easy"]},
	...
	{"name": "CAMPANELLA 2: Collect a total of 6 max HP & max fuel upgrades combined in a run", "types": ["campanella2", "easy"]}
],
[
...
[
	{"name": "LORDS OF DISKONIA: Win a Quick Battle on Commander difficulty", "types": ["lordsofdiskonia", "easy"]},
...
{"name": "STAR WASPIR: Have a 40x multiplier", "types": ["starwaspir", "easy"]},
	...
	{"name": "HOT FOOT: Reach round 4; in each round, the teammate that gets the first point must throw all bags for the rest of that round", "types": ["hotfoot", "easy"]},
{"name": "RAIL HEIST: GOOD-SPUR allowed; Devil Star on levels 1-4, and beat Fowl Business while killing every chicken & lawman", "types": ["railheist", "easy"]},
...
[
{"name": "BARBUTA: Obtain the blood sword, leave the room with 0 eggs, then gold disk", "types": ["barbuta", "easy"]},
{"name": "BARBUTA: Open 8 different chests", "types": ["barbuta", "easy"]},
{"name": "OVERBOLD: Gold Disk & Purchase 3 price hiked items in one run", "types": ["overbold", "easy"]},
{"name": "OVERBOLD: Gold Disk without purchasing any SALE items", "types": ["overbold", "easy"]},
	{"name": "MORTOL II: Defeat all three minibosses damaging them only as scout and engineer", "types": ["mortolii", "easy"]},
	...
	{"name": "AVIANOS: Win a custom Fledgling game; Must spend all possible resources every turn (change castles/flags to 6/0)", "types": ["avianos", "easy"]},
	...
	{"name": "ONION DELIVERY: Complete 2 days in a run with 8+ onions and at least 25 seconds left on the timer both days", "types": ["oniondelivery", "easy"]},
...
[
	...
	{"name": "PILOT QUEST: Return the science gear to the crash site", "types": ["pilotquest", "easy"]},
...
{"name": "NINPEK: Have 8 extra lives at once", "types": ["ninpek", "easy"]},
{"name": "WARPTANK: Beat Sectors without retrying at checkpoints, and destroying all possible enemies & blocks: Piston, Bomb, Tower, Healing, Stare", "types": ["warptank", "easy"]},
...
{"name": "MORTOL: Clear the first two levels without dying to any enemies", "types": ["mortol", "easy"]},
  ...
  [
	...
	{"name": "PORGY: Obtain an upgrade item from the Abyss (armor, radar, efficient fuel)", "types": ["porgy", "medium"]},
	...
	{"name": "THE BIG BELL RACE: Cherry disk with no deaths", "types": ["thebigbellrace", "medium"]},
...
{"name": "CAMPANELLA: Defeat every enemy on every level (no warps) in worlds A & B without collecting any other points", "types": ["campanella", "medium"]},
	{"name": "CYBER OWLS: Use GETM-EOUT; Complete the rescue mini-game four times in a row", "types": ["cyberowls", "medium"]},
...
[
	...
	{"name": "MAGIC GARDEN: Cherry disk in under 5:05 in-game time", "types": ["magicgarden", "medium"]},
	{"name": "MAGIC GARDEN: Gold disk; Ignore the first 5 drop-offs and never kill the mushrooms that spawn", "types": ["magicgarden", "medium"]},
...
{"name": "HOT FOOT: Win 5 games in one tournament without using any star abilities", "types": ["hotfoot", "medium"]},
	...
	{"name": "GRIMSTONE: Win four encounters in the western mine in one visit", "types": ["grimstone", "medium"]},
	...
	{"name": "ATTACTICS: Earn the gift; beat each of those levels without losing any flags", "types": ["attactics", "medium"]}
],
[
	...
	{"name": "PINGOLF: Score PAR better on eight holes in a row without dunking", "types": ["pingolf", "medium"]},
...
{"name": "HYPER CONTENDER: Win tournament mode; Change ring settings to the following values in order: 6, 1, 1, 5 ,5", "types": ["hypercontender", "medium"]},
...
{"name": "VELGRESS: Cherry disk with in-game time of 3:33 or less (no star blocks)", "types": ["velgress", "medium"]},
...
{"name": "BUSHIDO BALL: Win the first match as 4 different characters; enemies may not score more than 2 points in your victories", "types": ["bushidoball", "hard"]},
...
{"name": "BARBUTA: Cherry disk while holding the Rod", "types": ["barbuta", "medium"]},
  ...
  [
	...
	{"name": "KICK CLUB: Beat Track World; Must finish each level (except bosses) with 14+ seconds left on the timer", "types": ["kickclub", "hard"]},
...
{"name": "ELFAZAR’S HAT: Max out the bonus game meter twice in one run", "types": ["elfazarshat", "hard"]},
	{"name": "CAMPANELLA 3: Clear all waves through Stage D Wave 4 without firing sideways, then defeat Eggsaber", "types": ["campanella3", "hard"]},
...
{"name": "MOONCAT: Obtain the Yellow and Green eggs", "types": ["mooncat", "hard"]},
	{"name": "WARPTANK: Change your tank to each available color in the hub world (there are 5 color platforms)", "types": ["warptank", "hard"]},
...
{"name": "BUG HUNTER: WORK-LESS allowed; Beat Job 10", "types": ["bughunter", "hard"]},
	...
	{"name": "SEASIDE DRIVE: Wiin all 3 bonus games in one run without shooting any blcoks", "types": ["seasidedrive", "hard"]},
...
[
	...
	{"name": "HYPER CONTENDER: Beat Draft Mode on Hard Difficulty with 2 different characters", "types": ["hypercontender", "hard"]},
	{"name": "VAINGER: Collect three modules, then defeat Y-Vainger (exploit not allowed)", "types": ["vainger", "hard"]},
{"name": "VAINGER: Collect three modules, then defeat the keycode boss in Theta Sector", "types": ["vainger", "hard"]},
...
{"name": "PORGY: Defeat a boss in the second depth level (Bakunawa or Neptune)", "types": ["porgy", "hard"]},
	...
	{"name": "BARBUTA: Enter four unique doors (exits do not count as new doors)", "types": ["barbuta", "hard"]},
...
{"name": "ATTACTICS: Cherry disk", "types": ["attactics", "hard"]},
	{"name": "DIVERS: Reach level 3 and collect an emblem", "types": ["divers", "hard"]},
...
{"name": "ONION DELIVERY: Deliver 10 onions and complete the day on 4 separate days", "types": ["oniondelivery", "hard"]}
  ],
  [
	{"name": "VALBRACE: Use BUGG-BODY; Defeat the Phantom Knight without dying; Thrones, items (except keys), and spells not allowed during the run", "types": ["valbrace", "hard"]},
	...
	{"name": "CYBER OWLS: Beat Congo & Moscow without killing any non-boss enemies", "types": ["cyberowls", "hard"]},
	...
	{"name": "MINI & MAX: Collect a shiny quest reward from 4 different NPCs", "types": ["miniandmax", "hard"]},
	...
	{"name": "PARTY HOUSE: Beat A Magical Night with four maxed out Climbers AND four Werewolves", "types": ["partyhouse", "hard"]},
	...
	{"name": "MORTOL: OPEN-TOMB Allowed: Clear any 3 levels in worlds 2, 3, or 4 ending with +12 lives or more in each", "types": ["mortol", "hard"]}
],
[
...
{"name": "BARBUTA: Explore 48 different rooms", "types": ["barbuta", "veryhard"]}, 
	...
	{"name": "VELGRESS: Cherry disk without Upgrades or Jump Pads & finish with at least 75 coins held", "types": ["velgress", "veryhard"]},
	...
	{"name": "BLOCK KOALA: WORM-1234 allowed; clear any 10 odd-numbered story levels (levels 1-10 excluded)", "types": ["blockkoala", "veryhard"]},
	{"name": "BLOCK KOALA: WORM-1234 allowed; clear any 10 even-numbered story levels (levels 1-10 excluded)", "types": ["blockkoala", "veryhard"]},
...
{"name": "PORGY: Defeat 3 bosses", "types": ["porgy", "veryhard"]},
	{"name": "MOONCAT: Collect 2 of 3 eggs with 6 or fewer deaths (sum of best per successful run)", "types": ["mooncat", "veryhard"]},
	{"name": "MOONCAT: Cherry disk", "types": ["mooncat", "veryhard"]},
	{"name": "WALDORF’S JOURNEY: Cherry disk; No puffins collected & at least 5 weather vanes must be interacted with during the run", "types": ["waldorfsjourney", "veryhard"]},
	{"name": "WALDORF’S JOURNEY: Cherry disk with at least 91 shells", "types": ["waldorfsjourney", "veryhard"]},
{"name": "LORDS OF DISKONIA: Win a Full War on Commander difficulty", "types": ["lordsofdiskonia", "veryhard"]},
...
{"name": "ROCK ON! ISLAND: CLUB-PASS allowed; Beat the Four Emperors with 15 HP or more remaining", "types": ["rockonisland", "veryhard"]}
  ...
  [
	{"name": "RAKSHASA: Cherry disk with at least 55,000 points", "types": ["rakshasa", "veryhard"]},
	{"name": "RAKSHASA: Gold disk without upgrading the weapon", "types": ["rakshasa", "veryhard"]},
	{"name": "FIST HELL: Beat the fourth scare as Cat; Limit of 2 upgrade purchases", "types": ["fisthell", "veryhard"]},
	{"name": "FIST HELL: Beat the fourth scare as Amy; Limit of 2 upgrade purchases", "types": ["fisthell", "veryhard"]},
...
{"name": "ONION DELIVERY: Cherry Disk", "types": ["oniondelivery", "veryhard"]},
...
{"name": "Collect 12 gifts for the garden (6 from the first 25, 6 from the second 25 in Chronology)", "types": ["general", "general"]},
	...
	{"name": "Enter a number 1 top score on 2 arcade leaderboards; must gold disk the games to count", "types": ["general", "general"]},
...
{"name": "Cherry Disk Avianos or Hyper Contender", "types": ["general", "general"]},
{"name": "Cherry Disk Rail Heist or Party House", "types": ["general", "general"]},
{"name": "Obtain the gift in Lords of Diskonia or beat 30 levels in Block Koala", "types": ["general", "general"]},
...
{"name": "CAMPANELLA TRILOGY II: Cherry disk 2 of the 3 Campanella Trilogy games", "types": ["general", "general"]},
...
{"name": "ADVENTUREVANIA: Defeat 8 total bosses across Vainger, Porgy, Mini & Max, and Warptank with at least one in each", "types": ["general", "general"]}
  ]
] as const;
