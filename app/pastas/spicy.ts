export const SPICY = [
  ...
  [
    ...
    {
      name: "PARTY HOUSE: Beat Alien Invitation with at least 6 Aliens in the party; Drivers are banned",
      types: ["partyhouse", "medium"],
    },
    {
  ...
  [
    ...
    {
      name: "VAINGER: Equipd 3+ modules, then defeat the keycode boss in Theta Sector",
      types: ["vainger", "hard"],
    },
  ...
  [
    ...
    { name: "BARBUTA: Explore 48 different rooms", types: ["barbuta", "hard"] },
    {
  ...
  [
    ...
    {
      name: "NICE HAT: Defeat 2 bosses in Elfazar’s Hat, Rock On! Island, and Cyber Owls",
      types: ["general", "general"],
    },
    {
