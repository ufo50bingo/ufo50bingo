export const STANDARD_UFO = {
  "goals": {
    "easy": {
      ...
      "golfaria": [
        "GOLFARIA: Save 2 green ball NPCs",
    ...
    "medium": {
      ...
      "camouflage": [
        "CAMOUFLAGE: Escape with 5 babies",
      ...
      "rockonisland": [
        "ROCK ON! ISLAND: CLUB-PASS allowed; beat {{roi_level}}"
      ],
      "pingolf": [
    ...
    "hard": {
      ...
      "divers": [
        "DIVERS: Obtain a Lance weapon",
        "DIVERS: Pull 2 levers"
      ],
      "railheist": [
    ...
    "veryhard": {
      ...
      "planetzoldath": ["PLANET ZOLDATH: Use TROT-TERS; Beat seed {{dig1}}{{dig2}}{{dig3}}{{dig4}}{{dig5}}{{dig6}}"],
      ...
      "bushidoball": ["BUSHIDO BALL: Gold disk as {{bushido_gold}} (laws on, 8+ points)"],
      "blockkoala": ["BLOCK KOALA: WORM-1234 allowed; Beat levels {{bk_easy}}, {{bk_easy}}, {{bk_easy}}, {{bk_med}}, {{bk_med}}, {{bk_hard}}, {{bk_hard}}, & {{bk_vhard}}"],
      ...
      "pingolf": ["PINGOLF: Cherry disk without going over par on more than two holes"],
      "mortolii": ["MORTOL II: Activate all three switches without using portals or double jumps"],
      "fisthell": ["FIST HELL: Clear the 4th scare"],
      "overbold": ["OVERBOLD: Cherry Disk"],
      "campanella2": ["CAMPANELLA 2: Obtain 6 power-up items in one run (square icons on left of screen)"],
      "hypercontender": ["HYPER CONTENDER: Gold disk on Hard or Hyper Difficulty"],
      "valbrace": ["VALBRACE: Level up at two thrones & defeat the Phantom Knight on Floor 2"],
      "rakshasa": ["RAKSHASA: Gold disk"],
      "starwaspir": ["STAR WASPIR: Clear wave 3"],
      "grimstone": ["GRIMSTONE: With a posse of 4 all at level 3+, see 1500 teeth in your bank account"],
      "lordsofdiskonia": ["LORDS OF DISKONIA: Win a Full War on Knight+ Difficulty"],
    ...
    "general": {
      ...
      "bosslevel": [
        "Defeat 7 bosses from games on this card",
        {
          ...
          restriction: {
            count: 8,
            options: ["barbuta", "ninpek", "velgress", "kickclub", "mooncat", "campanella", "porgy", "caramelcaramel", "hotfoot", "vainger", "mortolii", "fisthell", "overbold", "campanella2", "rakshasa", "starwaspir", "elfazarshat", "miniandmax", "seasidedrive", "campanella3", "cyberowls"],
        ...
        },
        {
          ...
          restriction: {
            count: 6,
            options: ["kickclub", "mooncat", "campanella", "porgy", "caramelcaramel", "hotfoot", "vainger", "mortolii", "fisthell", "campanella2", "rakshasa", "starwaspir", "elfazarshat", "miniandmax", "seasidedrive", "campanella3", "cyberowls"],
        ...
        },
        {
          ...
          restriction: {
            count: 9,
            options: ["paintchase", "mortol", "velgress", "attactics", "devilition", "kickclub", "mooncat", "bushidoball", "blockkoala", "camouflage", "campanella", "thebigbellrace", "warptank", "oniondelivery", "caramelcaramel", "hotfoot", "railheist", "pingolf", "fisthell", "overbold", "campanella2", "starwaspir", "elfazarshat", "combatants", "campanella3", "cyberowls"],
        ...
        },
        {
          ...
          restriction: {
            count: 8,
            options: ["paintchase", "velgress", "attactics", "devilition", "kickclub", "mooncat", "bushidoball", "blockkoala", "camouflage", "campanella", "thebigbellrace", "warptank", "oniondelivery", "hotfoot", "railheist", "pingolf", "overbold", "campanella2", "combatants", "campanella3"],
        ...
        },
        {
          ...
          restriction: {
            count: 5,
            options: ["paintchase", "attactics", "kickclub", "mooncat", "blockkoala", "camouflage", "campanella", "thebigbellrace", "warptank", "railheist", "pingolf", "overbold", "campanella2", "campanella3"],
      ...
      "theme": [
        ...
        },
        {
          ...
          restriction: {
            ...
            fallback: "SHOOTER: Beat 5 waves/stages across Elfazar's Hat, Seaside Drive, and Caramel Caramel",
          },
        },
        {
        ...
        {
          name: "WAR IS BAD: Win 9 battles across Attactics, Avianos, and Combatants with 2+ in each",
          restriction: {
            count: 1,
            options: ["attactics", "avianos", "combatants"],
            fallback: "WAR IS BAD: Win 9 battles across Attactics, Avianos, and Combatants with 2+ in each",
          },
        },
        {
  ...
  "tokens": {
    ...
    "bk_easy": ["34", "42", "46", "7", "38", "17", "49"],
    "bk_med": ["36", "11", "4", "29", "48", "10", "18", "12", "30", "44", "27", "35", "26", "6"],
    "bk_hard": ["21", "31", "25", "20", "47", "9", "28", "39", "16", "37"],
    "bk_vhard": ["50", "14", "15", "24", "19", "45", "43", "23", "32", "8", "22", "3", "33", "41", "13"],
    "camo_easy": ["2", "3", "4", "5", "6", "7"],
    "camo_two_ez": ["2", "3", "8", "1"],
    "camo_two_long": ["7", "9", "4", "10", "11", "12", "13", "14"],
    "camo_three": ["8", "9", "10", "11", "12", "13", "14"],
    "warp_easy": ["Crust", "Bomb", "Garl", "Orb", "Stare", "Sore", "Form"],
    "warp_med": ["Dyad", "Sacrum", "Axom", "Nest", "Mazurka", "Tower", "Deep", "Nugget"],
    "warp_hard": ["Shock", "Riot", "Soft", "Port", "Kraft"],
    "porgy_upgrade": ["Buster Torpedoes", "Super Booster (Motor)"],
    "ph_scenario": ["High or Low", "Best Wishes", "Money Management", "A Magical Night"],
    "ph_all": ["Alien Invitation", "High or Low", "Best Wishes", "Money Management", "A Magical Night"],
    "hf_char": ["Jerry", "Amy", "Chandar", "Benjy", "Rizzik", "Bea", "Yoka", "Suze", "Marc", "Mascot", "July"],
    "hf_gold": ["Jerry", "Amy", "Chandar", "Benjy", "Rizzik", "Bea", "Yoka", "Suze", "Marc", "Mascot"],
    "rail_easy": ["A Simple Heist", "Roof Assault", "Cargo Ambust", "High Alert"],
    "rail_crate": ["Guarded by Gat", "Shifting Gears", "Vault Robbery", "Winging It", "Daring Duo", "Root Around", "Cow Poke", "Rescue Mission"],
    "rail_stars": ["Fowl Business", "Guarded by Gat", "Shifting Gears", "Vault Robbery", "Winging It", "Daring Duo", "Root Around", "Cow Poke", "Rescue Mission", "Long Haul", "Resupply", "Sitting Ducks"],
    "roi_level": ["The Oasis", "Jungle Rush", "Wasteland", "The Spiral", "Crossroads"],
    "roi_vh": ["Wasteland", "Jungle Rush", "Terror Overhead", "Crossroads"],
    "fh_char": ["Jay", "Victor", "Cat", "Amy"],
    "hc_char": ["Elka", "Sephy", "Reck", "Voltana", "Brazz", "Gilroy", "Yogo", "Donkus"],
