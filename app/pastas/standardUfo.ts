  ...
  "goals": {
    "easy": {
      ...
      "rakshasa": [
        ...
        "RAKSHASA: Equip all 3 weapons and score 6,000+ points in one run"
      ],
      "starwaspir": [
    ...
    "medium": {
      ...
      "porgy": [
        ...
        "PORGY: Equip the {{porgy_upgrade2}}"
      ],
      "oniondelivery": [
    ...
    "veryhard": {
      "barbuta": [
        "BARBUTA: Pay the hammer man to destroy the wall"
      ],
      "bughunter": [
        "BUG HUNTER: Gold disk"
      ],
      "ninpek": [
        "NINPEK: Use HARD-LOOP; Score 22,000+ points"
      ],
      "paintchase": [
        "PAINT CHASE: Score 350+ points"
      ],
      "magicgarden": [
        "MAGIC GARDEN: Win with a score of 50,000+"
      ],
      "mortol": [
        "MORTOL: OPEN-TOMB allowed; Beat all World 3 & World 4 levels"
      ],
      "velgress": [
      ...
      "attactics": [
        "ATTACTICS: Reach Lord (100+) in Ranked Mode"
      ],
      "devilition": [
        "DEVILITION: Reach round 8"
      ],
      "kickclub": [
        "KICK CLUB: Score 150,000+ points or gold disk"
      ],
      "avianos": [
        "AVIANOS: Gold disk"
      ],
      ...
      "golfaria": [
        "GOLFARIA: Collect 5 clubs & the Sand Roll in one run"
      ],
      "thebigbellrace": [
        "THE BIG BELL RACE: Gold disk with no deaths"
      ],
      "warptank": [
      ...
      "porgy": [
        "PORGY: Show 20%+ Completion in the library"
      ],
      "oniondelivery": [
        "ONION DELIVERY: Gold disk"
      ],
      "caramelcaramel": [
        "CARAMEL CARAMEL: Score 100,000+ points or Gold disk"
      ],
      "partyhouse": [
        "PARTY HOUSE: Beat 2 random scenarios in a row"
      ],
      "hotfoot": [
        "HOT FOOT: Gold disk using {{hf_gold}} & {{hf_gold}}"
      ],
      "divers": [
        "DIVERS: Win a fight against Piranhas"
      ],
      "railheist": [
      ...
      "rockonisland": [
        "ROCK ON! ISLAND: CLUB-PASS allowed; Perfect {{roi_vh}}"
      ],
      "pingolf": [
      ...
      "elfazarshat": [
        "ELFAZAR'S HAT: Clear Stage 4"
      ],
      "pilotquest": [
        "PILOT QUEST: Return a ship part to the crash site"
      ],
      "miniandmax": [
        "MINI & MAX: Have 350+ shinies at once"
      ],
      "combatants": [
      ...
      "seasidedrive": [
        "SEASIDE DRIVE: Score 200,000+ points or gold disk"
      ],
      "campanella3": [
        "CAMPANELLA 3: Earn 2 star waves in Stage D"
      ],
      "cyberowls": [
