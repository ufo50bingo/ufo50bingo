...
export default function FileSyncSection({
  ...
  return (
    <Accordion.Item value="advanced">
      <Accordion.Control>Advanced OBS Integration</Accordion.Control>
      <Accordion.Panel>
        <Stack>
          <Text size="sm">
            If you want more advanced OBS integrations, you can sync the data
            from this page to files on your computer, and use those files as
            text sources in OBS.
          </Text>
          ...
          {dirHandle == null ? (
            ...
            <>
              <Text size="sm">
                Currently syncing to <strong>{dirHandle.name}</strong>
              </Text>
              <Button
                color="red"
                onClick={async () => {
