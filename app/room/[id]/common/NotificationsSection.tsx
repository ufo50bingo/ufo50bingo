      ...
      <Accordion.Panel>
        <Stack>
          <SoundSelector
            ...
            sound={soundChoices.pause}
            setSound={setSoundChoices.setPause}
          />
          <SoundSelector
            label="Square claimed"
            sound={soundChoices.square}
            setSound={setSoundChoices.setSquare}
          />
          <SoundSelector
            label="Chat received"
            sound={soundChoices.chat}
            setSound={setSoundChoices.setChat}
          />
        </Stack>
      </Accordion.Panel>
    </Accordion.Item>
