        ...
        <Card.Section withBorder={true} inheritPadding={true} p="md">
          <Stack>
            ...
            <Text size="lg">
              ...
              {dayjs().format("z")}) to generate a Discord timestamp which will
              be localized to each viewer's timezone.
            </Text>
            <Stack align="center">
              <DatePicker
                value={date}
            ...
            {format === "t" && (
              ...
              >
                The time-only format is not recommended, because it may
                represent different dates for viewers in different timezones.
                For example, 10 PM in your timezone may be 6 AM the next day in
